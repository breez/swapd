...
class LookupHtlcResolutionRequest(_message.Message):
    ...
    htlc_index: int
    def __init__(
        self, chan_id: _Optional[int] = ..., htlc_index: _Optional[int] = ...
    ) -> None: ...
...
class Utxo(_message.Message):
    ...
    def __init__(
        ...
        pk_script: _Optional[str] = ...,
        outpoint: _Optional[_Union[OutPoint, _Mapping]] = ...,
...
class OutputDetail(_message.Message):
    ...
    def __init__(
        self,
        output_type: _Optional[_Union[OutputScriptType, str]] = ...,
        address: _Optional[str] = ...,
        pk_script: _Optional[str] = ...,
        output_index: _Optional[int] = ...,
...
class Transaction(_message.Message):
    ...
    def __init__(
        ...
        amount: _Optional[int] = ...,
        num_confirmations: _Optional[int] = ...,
        block_hash: _Optional[str] = ...,
        block_height: _Optional[int] = ...,
        time_stamp: _Optional[int] = ...,
        total_fees: _Optional[int] = ...,
        dest_addresses: _Optional[_Iterable[str]] = ...,
        output_details: _Optional[_Iterable[_Union[OutputDetail, _Mapping]]] = ...,
        raw_tx_hex: _Optional[str] = ...,
        label: _Optional[str] = ...,
        previous_outpoints: _Optional[
            _Iterable[_Union[PreviousOutPoint, _Mapping]]
        ] = ...,
    ) -> None: ...

class GetTransactionsRequest(_message.Message):
    __slots__ = ("start_height", "end_height", "account")
    ...
    def __init__(
        self,
        start_height: _Optional[int] = ...,
        end_height: _Optional[int] = ...,
...
class SendRequest(_message.Message):
    ...
    class DestCustomRecordsEntry(_message.Message):
        ...
        value: bytes
        def __init__(
            self, key: _Optional[int] = ..., value: _Optional[bytes] = ...
        ) -> None: ...
    ...
    def __init__(
        self,
        dest: _Optional[bytes] = ...,
        dest_string: _Optional[str] = ...,
        amt: _Optional[int] = ...,
        amt_msat: _Optional[int] = ...,
        payment_hash: _Optional[bytes] = ...,
        payment_hash_string: _Optional[str] = ...,
        payment_request: _Optional[str] = ...,
        final_cltv_delta: _Optional[int] = ...,
        fee_limit: _Optional[_Union[FeeLimit, _Mapping]] = ...,
        outgoing_chan_id: _Optional[int] = ...,
        last_hop_pubkey: _Optional[bytes] = ...,
        cltv_limit: _Optional[int] = ...,
        dest_custom_records: _Optional[_Mapping[int, bytes]] = ...,
        allow_self_payment: bool = ...,
        dest_features: _Optional[_Iterable[_Union[FeatureBit, str]]] = ...,
        payment_addr: _Optional[bytes] = ...,
    ) -> None: ...
...
class SendResponse(_message.Message):
    ...
    def __init__(
        self,
        payment_error: _Optional[str] = ...,
        payment_preimage: _Optional[bytes] = ...,
        payment_route: _Optional[_Union[Route, _Mapping]] = ...,
        payment_hash: _Optional[bytes] = ...,
    ) -> None: ...
...
class ChannelAcceptRequest(_message.Message):
    ...
    def __init__(
        self,
        node_pubkey: _Optional[bytes] = ...,
        chain_hash: _Optional[bytes] = ...,
        pending_chan_id: _Optional[bytes] = ...,
        funding_amt: _Optional[int] = ...,
        push_amt: _Optional[int] = ...,
        dust_limit: _Optional[int] = ...,
        max_value_in_flight: _Optional[int] = ...,
        channel_reserve: _Optional[int] = ...,
        min_htlc: _Optional[int] = ...,
        fee_per_kw: _Optional[int] = ...,
        csv_delay: _Optional[int] = ...,
        max_accepted_htlcs: _Optional[int] = ...,
        channel_flags: _Optional[int] = ...,
        commitment_type: _Optional[_Union[CommitmentType, str]] = ...,
        wants_zero_conf: bool = ...,
        wants_scid_alias: bool = ...,
    ) -> None: ...
...
class ChannelAcceptResponse(_message.Message):
    ...
    def __init__(
        ...
        pending_chan_id: _Optional[bytes] = ...,
        error: _Optional[str] = ...,
        upfront_shutdown: _Optional[str] = ...,
        csv_delay: _Optional[int] = ...,
        reserve_sat: _Optional[int] = ...,
        in_flight_max_msat: _Optional[int] = ...,
        max_htlc_count: _Optional[int] = ...,
        min_htlc_in: _Optional[int] = ...,
        min_accept_depth: _Optional[int] = ...,
        zero_conf: bool = ...,
    ) -> None: ...
...
class ChannelPoint(_message.Message):
    ...
    def __init__(
        self,
        funding_txid_bytes: _Optional[bytes] = ...,
        funding_txid_str: _Optional[str] = ...,
        output_index: _Optional[int] = ...,
    ) -> None: ...
...
class OutPoint(_message.Message):
    ...
    def __init__(
        self,
        txid_bytes: _Optional[bytes] = ...,
        txid_str: _Optional[str] = ...,
        output_index: _Optional[int] = ...,
    ) -> None: ...
...
class PreviousOutPoint(_message.Message):
    ...
    is_our_output: bool
    def __init__(
        self, outpoint: _Optional[str] = ..., is_our_output: bool = ...
    ) -> None: ...
...
class LightningAddress(_message.Message):
    ...
    host: str
    def __init__(
        self, pubkey: _Optional[str] = ..., host: _Optional[str] = ...
    ) -> None: ...
...
class EstimateFeeRequest(_message.Message):
    ...
    def __init__(
        self,
        AddrToAmount: _Optional[_Mapping[str, int]] = ...,
        target_conf: _Optional[int] = ...,
        min_confs: _Optional[int] = ...,
        spend_unconfirmed: bool = ...,
        coin_selection_strategy: _Optional[_Union[CoinSelectionStrategy, str]] = ...,
    ) -> None: ...
...
class EstimateFeeResponse(_message.Message):
    ...
    def __init__(
        self,
        fee_sat: _Optional[int] = ...,
        feerate_sat_per_byte: _Optional[int] = ...,
...
class SendCoinsRequest(_message.Message):
    ...
    def __init__(
        ...
        spend_unconfirmed: bool = ...,
        coin_selection_strategy: _Optional[_Union[CoinSelectionStrategy, str]] = ...,
        outpoints: _Optional[_Iterable[_Union[OutPoint, _Mapping]]] = ...,
    ) -> None: ...
...
class ListUnspentResponse(_message.Message):
    ...
    def __init__(
        self, utxos: _Optional[_Iterable[_Union[Utxo, _Mapping]]] = ...
    ) -> None: ...
...
class SignMessageRequest(_message.Message):
    ...
    single_hash: bool
    def __init__(
        self, msg: _Optional[bytes] = ..., single_hash: bool = ...
    ) -> None: ...
...
class VerifyMessageRequest(_message.Message):
    ...
    signature: str
    def __init__(
        self, msg: _Optional[bytes] = ..., signature: _Optional[str] = ...
    ) -> None: ...
...
class ConnectPeerRequest(_message.Message):
    ...
    def __init__(
        self,
        addr: _Optional[_Union[LightningAddress, _Mapping]] = ...,
        perm: bool = ...,
...
class HTLC(_message.Message):
    ...
    def __init__(
        ...
        incoming: bool = ...,
        amount: _Optional[int] = ...,
        hash_lock: _Optional[bytes] = ...,
        expiration_height: _Optional[int] = ...,
        htlc_index: _Optional[int] = ...,
        forwarding_channel: _Optional[int] = ...,
        forwarding_htlc_index: _Optional[int] = ...,
    ) -> None: ...
...
class ChannelConstraints(_message.Message):
    ...
    def __init__(
        self,
        csv_delay: _Optional[int] = ...,
        chan_reserve_sat: _Optional[int] = ...,
        dust_limit_sat: _Optional[int] = ...,
        max_pending_amt_msat: _Optional[int] = ...,
        min_htlc_msat: _Optional[int] = ...,
        max_accepted_htlcs: _Optional[int] = ...,
    ) -> None: ...
...
class Channel(_message.Message):
    ...
    def __init__(
        self,
        active: bool = ...,
        remote_pubkey: _Optional[str] = ...,
        channel_point: _Optional[str] = ...,
        chan_id: _Optional[int] = ...,
        capacity: _Optional[int] = ...,
        local_balance: _Optional[int] = ...,
        remote_balance: _Optional[int] = ...,
        commit_fee: _Optional[int] = ...,
        commit_weight: _Optional[int] = ...,
        fee_per_kw: _Optional[int] = ...,
        unsettled_balance: _Optional[int] = ...,
        total_satoshis_sent: _Optional[int] = ...,
        total_satoshis_received: _Optional[int] = ...,
        num_updates: _Optional[int] = ...,
        pending_htlcs: _Optional[_Iterable[_Union[HTLC, _Mapping]]] = ...,
        csv_delay: _Optional[int] = ...,
        private: bool = ...,
        initiator: bool = ...,
        chan_status_flags: _Optional[str] = ...,
        local_chan_reserve_sat: _Optional[int] = ...,
        remote_chan_reserve_sat: _Optional[int] = ...,
        static_remote_key: bool = ...,
        commitment_type: _Optional[_Union[CommitmentType, str]] = ...,
        lifetime: _Optional[int] = ...,
        uptime: _Optional[int] = ...,
        close_address: _Optional[str] = ...,
        push_amount_sat: _Optional[int] = ...,
        thaw_height: _Optional[int] = ...,
        local_constraints: _Optional[_Union[ChannelConstraints, _Mapping]] = ...,
        remote_constraints: _Optional[_Union[ChannelConstraints, _Mapping]] = ...,
        alias_scids: _Optional[_Iterable[int]] = ...,
        zero_conf: bool = ...,
        zero_conf_confirmed_scid: _Optional[int] = ...,
        peer_alias: _Optional[str] = ...,
        peer_scid_alias: _Optional[int] = ...,
        memo: _Optional[str] = ...,
    ) -> None: ...
...
class ListChannelsResponse(_message.Message):
    ...
    def __init__(
        self, channels: _Optional[_Iterable[_Union[Channel, _Mapping]]] = ...
    ) -> None: ...
...
class AliasMap(_message.Message):
    ...
    def __init__(
        self, base_scid: _Optional[int] = ..., aliases: _Optional[_Iterable[int]] = ...
    ) -> None: ...
...
class ListAliasesResponse(_message.Message):
    ...
    def __init__(
        self, alias_maps: _Optional[_Iterable[_Union[AliasMap, _Mapping]]] = ...
    ) -> None: ...
...
class ChannelCloseSummary(_message.Message):
    ...
    def __init__(
        ...
        channel_point: _Optional[str] = ...,
        chan_id: _Optional[int] = ...,
        chain_hash: _Optional[str] = ...,
        closing_tx_hash: _Optional[str] = ...,
        remote_pubkey: _Optional[str] = ...,
        capacity: _Optional[int] = ...,
        close_height: _Optional[int] = ...,
        settled_balance: _Optional[int] = ...,
        time_locked_balance: _Optional[int] = ...,
        close_type: _Optional[_Union[ChannelCloseSummary.ClosureType, str]] = ...,
        open_initiator: _Optional[_Union[Initiator, str]] = ...,
        close_initiator: _Optional[_Union[Initiator, str]] = ...,
        resolutions: _Optional[_Iterable[_Union[Resolution, _Mapping]]] = ...,
        alias_scids: _Optional[_Iterable[int]] = ...,
        zero_conf_confirmed_scid: _Optional[int] = ...,
    ) -> None: ...
...
class Resolution(_message.Message):
    ...
    def __init__(
        self,
        resolution_type: _Optional[_Union[ResolutionType, str]] = ...,
        outcome: _Optional[_Union[ResolutionOutcome, str]] = ...,
        outpoint: _Optional[_Union[OutPoint, _Mapping]] = ...,
        amount_sat: _Optional[int] = ...,
        sweep_txid: _Optional[str] = ...,
    ) -> None: ...
...
class ClosedChannelsResponse(_message.Message):
    ...
    def __init__(
        self,
        channels: _Optional[_Iterable[_Union[ChannelCloseSummary, _Mapping]]] = ...,
    ) -> None: ...
...
class Peer(_message.Message):
    ...
    class FeaturesEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[int] = ...,
            value: _Optional[_Union[Feature, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        bytes_recv: _Optional[int] = ...,
        sat_sent: _Optional[int] = ...,
        sat_recv: _Optional[int] = ...,
        inbound: bool = ...,
        ping_time: _Optional[int] = ...,
        sync_type: _Optional[_Union[Peer.SyncType, str]] = ...,
        features: _Optional[_Mapping[int, Feature]] = ...,
        errors: _Optional[_Iterable[_Union[TimestampedError, _Mapping]]] = ...,
        flap_count: _Optional[int] = ...,
        last_flap_ns: _Optional[int] = ...,
        last_ping_payload: _Optional[bytes] = ...,
    ) -> None: ...
...
class TimestampedError(_message.Message):
    ...
    error: str
    def __init__(
        self, timestamp: _Optional[int] = ..., error: _Optional[str] = ...
    ) -> None: ...
...
class PeerEvent(_message.Message):
    ...
    def __init__(
        self,
        pub_key: _Optional[str] = ...,
        type: _Optional[_Union[PeerEvent.EventType, str]] = ...,
    ) -> None: ...
...
class GetInfoResponse(_message.Message):
    ...
    def __init__(
        ...
        identity_pubkey: _Optional[str] = ...,
        alias: _Optional[str] = ...,
        color: _Optional[str] = ...,
        num_pending_channels: _Optional[int] = ...,
        num_active_channels: _Optional[int] = ...,
        num_inactive_channels: _Optional[int] = ...,
        num_peers: _Optional[int] = ...,
        block_height: _Optional[int] = ...,
        block_hash: _Optional[str] = ...,
        best_header_timestamp: _Optional[int] = ...,
        synced_to_chain: bool = ...,
        synced_to_graph: bool = ...,
        testnet: bool = ...,
        chains: _Optional[_Iterable[_Union[Chain, _Mapping]]] = ...,
...
class Chain(_message.Message):
    ...
    network: str
    def __init__(
        self, chain: _Optional[str] = ..., network: _Optional[str] = ...
    ) -> None: ...

class ConfirmationUpdate(_message.Message):
    __slots__ = ("block_sha", "block_height", "num_confs_left")
    BLOCK_SHA_FIELD_NUMBER: _ClassVar[int]
    BLOCK_HEIGHT_FIELD_NUMBER: _ClassVar[int]
    NUM_CONFS_LEFT_FIELD_NUMBER: _ClassVar[int]
    block_sha: bytes
    block_height: int
    num_confs_left: int
    def __init__(
        self,
        block_sha: _Optional[bytes] = ...,
        block_height: _Optional[int] = ...,
        num_confs_left: _Optional[int] = ...,
    ) -> None: ...
...
class ChannelOpenUpdate(_message.Message):
    ...
    def __init__(
        self, channel_point: _Optional[_Union[ChannelPoint, _Mapping]] = ...
    ) -> None: ...

class ChannelCloseUpdate(_message.Message):
    __slots__ = ("closing_txid", "success")
    CLOSING_TXID_FIELD_NUMBER: _ClassVar[int]
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    closing_txid: bytes
    success: bool
    def __init__(
        self, closing_txid: _Optional[bytes] = ..., success: bool = ...
    ) -> None: ...
...
class CloseChannelRequest(_message.Message):
    ...
    def __init__(
        self,
        channel_point: _Optional[_Union[ChannelPoint, _Mapping]] = ...,
        force: bool = ...,
        target_conf: _Optional[int] = ...,
        sat_per_byte: _Optional[int] = ...,
        delivery_address: _Optional[str] = ...,
        sat_per_vbyte: _Optional[int] = ...,
        max_fee_per_vbyte: _Optional[int] = ...,
        no_wait: bool = ...,
    ) -> None: ...
...
class CloseStatusUpdate(_message.Message):
    ...
    def __init__(
        self,
        close_pending: _Optional[_Union[PendingUpdate, _Mapping]] = ...,
        chan_close: _Optional[_Union[ChannelCloseUpdate, _Mapping]] = ...,
        close_instant: _Optional[_Union[InstantUpdate, _Mapping]] = ...,
    ) -> None: ...

class PendingUpdate(_message.Message):
    __slots__ = ("txid", "output_index")
    TXID_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_INDEX_FIELD_NUMBER: _ClassVar[int]
    txid: bytes
    output_index: int
    def __init__(
        self, txid: _Optional[bytes] = ..., output_index: _Optional[int] = ...
    ) -> None: ...
...
class ReadyForPsbtFunding(_message.Message):
    ...
    def __init__(
        self,
        funding_address: _Optional[str] = ...,
        funding_amount: _Optional[int] = ...,
...
class BatchOpenChannelRequest(_message.Message):
    ...
    def __init__(
        self,
        channels: _Optional[_Iterable[_Union[BatchOpenChannel, _Mapping]]] = ...,
        target_conf: _Optional[int] = ...,
        sat_per_vbyte: _Optional[int] = ...,
        min_confs: _Optional[int] = ...,
        spend_unconfirmed: bool = ...,
...
class BatchOpenChannel(_message.Message):
    ...
    def __init__(
        self,
        node_pubkey: _Optional[bytes] = ...,
        local_funding_amount: _Optional[int] = ...,
        push_sat: _Optional[int] = ...,
        private: bool = ...,
        min_htlc_msat: _Optional[int] = ...,
        remote_csv_delay: _Optional[int] = ...,
        close_address: _Optional[str] = ...,
        pending_chan_id: _Optional[bytes] = ...,
        commitment_type: _Optional[_Union[CommitmentType, str]] = ...,
        remote_max_value_in_flight_msat: _Optional[int] = ...,
        remote_max_htlcs: _Optional[int] = ...,
        max_local_csv: _Optional[int] = ...,
        zero_conf: bool = ...,
        scid_alias: bool = ...,
        base_fee: _Optional[int] = ...,
        fee_rate: _Optional[int] = ...,
        use_base_fee: bool = ...,
        use_fee_rate: bool = ...,
        remote_chan_reserve_sat: _Optional[int] = ...,
        memo: _Optional[str] = ...,
...
class BatchOpenChannelResponse(_message.Message):
    ...
    def __init__(
        self,
        pending_channels: _Optional[_Iterable[_Union[PendingUpdate, _Mapping]]] = ...,
    ) -> None: ...
...
class OpenChannelRequest(_message.Message):
    ...
    def __init__(
        ...
        sat_per_vbyte: _Optional[int] = ...,
        node_pubkey: _Optional[bytes] = ...,
        node_pubkey_string: _Optional[str] = ...,
        local_funding_amount: _Optional[int] = ...,
        push_sat: _Optional[int] = ...,
        target_conf: _Optional[int] = ...,
        sat_per_byte: _Optional[int] = ...,
        ...
        spend_unconfirmed: bool = ...,
        close_address: _Optional[str] = ...,
        funding_shim: _Optional[_Union[FundingShim, _Mapping]] = ...,
        remote_max_value_in_flight_msat: _Optional[int] = ...,
        remote_max_htlcs: _Optional[int] = ...,
        max_local_csv: _Optional[int] = ...,
        commitment_type: _Optional[_Union[CommitmentType, str]] = ...,
...
class OpenStatusUpdate(_message.Message):
    ...
    def __init__(
        self,
        chan_pending: _Optional[_Union[PendingUpdate, _Mapping]] = ...,
        chan_open: _Optional[_Union[ChannelOpenUpdate, _Mapping]] = ...,
        psbt_fund: _Optional[_Union[ReadyForPsbtFunding, _Mapping]] = ...,
        pending_chan_id: _Optional[bytes] = ...,
    ) -> None: ...
...
class ChanPointShim(_message.Message):
    ...
    def __init__(
        self,
        amt: _Optional[int] = ...,
        chan_point: _Optional[_Union[ChannelPoint, _Mapping]] = ...,
        local_key: _Optional[_Union[KeyDescriptor, _Mapping]] = ...,
        remote_key: _Optional[bytes] = ...,
        pending_chan_id: _Optional[bytes] = ...,
        thaw_height: _Optional[int] = ...,
        musig2: bool = ...,
    ) -> None: ...
...
class FundingShim(_message.Message):
    ...
    def __init__(
        self,
        chan_point_shim: _Optional[_Union[ChanPointShim, _Mapping]] = ...,
        psbt_shim: _Optional[_Union[PsbtShim, _Mapping]] = ...,
    ) -> None: ...
...
class FundingTransitionMsg(_message.Message):
    ...
    def __init__(
        self,
        shim_register: _Optional[_Union[FundingShim, _Mapping]] = ...,
        shim_cancel: _Optional[_Union[FundingShimCancel, _Mapping]] = ...,
        psbt_verify: _Optional[_Union[FundingPsbtVerify, _Mapping]] = ...,
        psbt_finalize: _Optional[_Union[FundingPsbtFinalize, _Mapping]] = ...,
    ) -> None: ...
...
class PendingHTLC(_message.Message):
    ...
    def __init__(
        ...
        maturity_height: _Optional[int] = ...,
        blocks_til_maturity: _Optional[int] = ...,
        stage: _Optional[int] = ...,
    ) -> None: ...
...
class PendingChannelsResponse(_message.Message):
    ...
    class PendingChannel(_message.Message):
        ...
        def __init__(
            ...
            local_chan_reserve_sat: _Optional[int] = ...,
            remote_chan_reserve_sat: _Optional[int] = ...,
            initiator: _Optional[_Union[Initiator, str]] = ...,
            commitment_type: _Optional[_Union[CommitmentType, str]] = ...,
            num_forwarding_packages: _Optional[int] = ...,
            chan_status_flags: _Optional[str] = ...,
            private: bool = ...,
            memo: _Optional[str] = ...,
        ) -> None: ...
    ...
    class PendingOpenChannel(_message.Message):
        ...
        def __init__(
            self,
            channel: _Optional[
                _Union[PendingChannelsResponse.PendingChannel, _Mapping]
            ] = ...,
            commit_fee: _Optional[int] = ...,
            commit_weight: _Optional[int] = ...,
            fee_per_kw: _Optional[int] = ...,
            funding_expiry_blocks: _Optional[int] = ...,
        ) -> None: ...
    ...
    class WaitingCloseChannel(_message.Message):
        ...
        def __init__(
            ...
            limbo_balance: _Optional[int] = ...,
            commitments: _Optional[
                _Union[PendingChannelsResponse.Commitments, _Mapping]
            ] = ...,
            closing_txid: _Optional[str] = ...,
            closing_tx_hex: _Optional[str] = ...,
        ) -> None: ...
    ...
    class Commitments(_message.Message):
        ...
        def __init__(
            self,
            local_txid: _Optional[str] = ...,
            remote_txid: _Optional[str] = ...,
            remote_pending_txid: _Optional[str] = ...,
            local_commit_fee_sat: _Optional[int] = ...,
            remote_commit_fee_sat: _Optional[int] = ...,
            remote_pending_commit_fee_sat: _Optional[int] = ...,
        ) -> None: ...
    ...
    class ForceClosedChannel(_message.Message):
        ...
        def __init__(
            ...
            maturity_height: _Optional[int] = ...,
            blocks_til_maturity: _Optional[int] = ...,
            recovered_balance: _Optional[int] = ...,
            pending_htlcs: _Optional[_Iterable[_Union[PendingHTLC, _Mapping]]] = ...,
            anchor: _Optional[
                _Union[PendingChannelsResponse.ForceClosedChannel.AnchorState, str]
            ] = ...,
        ) -> None: ...
    ...
    pending_open_channels: _containers.RepeatedCompositeFieldContainer[
        PendingChannelsResponse.PendingOpenChannel
    ]
    pending_closing_channels: _containers.RepeatedCompositeFieldContainer[
        PendingChannelsResponse.ClosedChannel
    ]
    pending_force_closing_channels: _containers.RepeatedCompositeFieldContainer[
        PendingChannelsResponse.ForceClosedChannel
    ]
    waiting_close_channels: _containers.RepeatedCompositeFieldContainer[
        PendingChannelsResponse.WaitingCloseChannel
    ]
    def __init__(
        self,
        total_limbo_balance: _Optional[int] = ...,
        pending_open_channels: _Optional[
            _Iterable[_Union[PendingChannelsResponse.PendingOpenChannel, _Mapping]]
        ] = ...,
        pending_closing_channels: _Optional[
            _Iterable[_Union[PendingChannelsResponse.ClosedChannel, _Mapping]]
        ] = ...,
        pending_force_closing_channels: _Optional[
            _Iterable[_Union[PendingChannelsResponse.ForceClosedChannel, _Mapping]]
        ] = ...,
        waiting_close_channels: _Optional[
            _Iterable[_Union[PendingChannelsResponse.WaitingCloseChannel, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class ChannelEventUpdate(_message.Message):
    ...
    def __init__(
        self,
        open_channel: _Optional[_Union[Channel, _Mapping]] = ...,
        closed_channel: _Optional[_Union[ChannelCloseSummary, _Mapping]] = ...,
        active_channel: _Optional[_Union[ChannelPoint, _Mapping]] = ...,
        inactive_channel: _Optional[_Union[ChannelPoint, _Mapping]] = ...,
        pending_open_channel: _Optional[_Union[PendingUpdate, _Mapping]] = ...,
        fully_resolved_channel: _Optional[_Union[ChannelPoint, _Mapping]] = ...,
        type: _Optional[_Union[ChannelEventUpdate.UpdateType, str]] = ...,
    ) -> None: ...
...
class WalletAccountBalance(_message.Message):
    ...
    def __init__(
        self,
        confirmed_balance: _Optional[int] = ...,
        unconfirmed_balance: _Optional[int] = ...,
    ) -> None: ...
...
class WalletBalanceRequest(_message.Message):
    ...
    min_confs: int
    def __init__(
        self, account: _Optional[str] = ..., min_confs: _Optional[int] = ...
    ) -> None: ...
...
class WalletBalanceResponse(_message.Message):
    ...
    class AccountBalanceEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[WalletAccountBalance, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        total_balance: _Optional[int] = ...,
        confirmed_balance: _Optional[int] = ...,
        unconfirmed_balance: _Optional[int] = ...,
        locked_balance: _Optional[int] = ...,
        reserved_balance_anchor_chan: _Optional[int] = ...,
        account_balance: _Optional[_Mapping[str, WalletAccountBalance]] = ...,
    ) -> None: ...
...
class Amount(_message.Message):
    ...
    msat: int
    def __init__(
        self, sat: _Optional[int] = ..., msat: _Optional[int] = ...
    ) -> None: ...
...
class ChannelBalanceResponse(_message.Message):
    ...
    def __init__(
        ...
        pending_open_balance: _Optional[int] = ...,
        local_balance: _Optional[_Union[Amount, _Mapping]] = ...,
        remote_balance: _Optional[_Union[Amount, _Mapping]] = ...,
        unsettled_local_balance: _Optional[_Union[Amount, _Mapping]] = ...,
        unsettled_remote_balance: _Optional[_Union[Amount, _Mapping]] = ...,
        pending_open_local_balance: _Optional[_Union[Amount, _Mapping]] = ...,
        pending_open_remote_balance: _Optional[_Union[Amount, _Mapping]] = ...,
    ) -> None: ...
...
class QueryRoutesRequest(_message.Message):
    ...
    blinded_payment_paths: _containers.RepeatedCompositeFieldContainer[
        BlindedPaymentPath
    ]
    dest_features: _containers.RepeatedScalarFieldContainer[FeatureBit]
    time_pref: float
    def __init__(
        ...
        final_cltv_delta: _Optional[int] = ...,
        fee_limit: _Optional[_Union[FeeLimit, _Mapping]] = ...,
        ignored_nodes: _Optional[_Iterable[bytes]] = ...,
        ignored_edges: _Optional[_Iterable[_Union[EdgeLocator, _Mapping]]] = ...,
        source_pub_key: _Optional[str] = ...,
        use_mission_control: bool = ...,
        ignored_pairs: _Optional[_Iterable[_Union[NodePair, _Mapping]]] = ...,
        cltv_limit: _Optional[int] = ...,
        dest_custom_records: _Optional[_Mapping[int, bytes]] = ...,
        outgoing_chan_id: _Optional[int] = ...,
        last_hop_pubkey: _Optional[bytes] = ...,
        route_hints: _Optional[_Iterable[_Union[RouteHint, _Mapping]]] = ...,
        blinded_payment_paths: _Optional[
            _Iterable[_Union[BlindedPaymentPath, _Mapping]]
        ] = ...,
        dest_features: _Optional[_Iterable[_Union[FeatureBit, str]]] = ...,
        time_pref: _Optional[float] = ...,
    ) -> None: ...
...
class EdgeLocator(_message.Message):
    ...
    def __init__(
        self, channel_id: _Optional[int] = ..., direction_reverse: bool = ...
    ) -> None: ...
...
class Hop(_message.Message):
    ...
    def __init__(
        self,
        chan_id: _Optional[int] = ...,
        chan_capacity: _Optional[int] = ...,
        amt_to_forward: _Optional[int] = ...,
        fee: _Optional[int] = ...,
        expiry: _Optional[int] = ...,
        amt_to_forward_msat: _Optional[int] = ...,
        fee_msat: _Optional[int] = ...,
        pub_key: _Optional[str] = ...,
        tlv_payload: bool = ...,
        mpp_record: _Optional[_Union[MPPRecord, _Mapping]] = ...,
        amp_record: _Optional[_Union[AMPRecord, _Mapping]] = ...,
        custom_records: _Optional[_Mapping[int, bytes]] = ...,
        metadata: _Optional[bytes] = ...,
        blinding_point: _Optional[bytes] = ...,
        encrypted_data: _Optional[bytes] = ...,
        total_amt_msat: _Optional[int] = ...,
    ) -> None: ...
...
class MPPRecord(_message.Message):
    ...
    total_amt_msat: int
    def __init__(
        self, payment_addr: _Optional[bytes] = ..., total_amt_msat: _Optional[int] = ...
    ) -> None: ...
...
class AMPRecord(_message.Message):
    ...
    def __init__(
        self,
        root_share: _Optional[bytes] = ...,
        set_id: _Optional[bytes] = ...,
...
class Route(_message.Message):
    ...
    def __init__(
        self,
        total_time_lock: _Optional[int] = ...,
        total_fees: _Optional[int] = ...,
        total_amt: _Optional[int] = ...,
        hops: _Optional[_Iterable[_Union[Hop, _Mapping]]] = ...,
        total_fees_msat: _Optional[int] = ...,
        total_amt_msat: _Optional[int] = ...,
    ) -> None: ...

class NodeInfoRequest(_message.Message):
    __slots__ = ("pub_key", "include_channels")
    PUB_KEY_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_CHANNELS_FIELD_NUMBER: _ClassVar[int]
    pub_key: str
    include_channels: bool
    def __init__(
        self, pub_key: _Optional[str] = ..., include_channels: bool = ...
    ) -> None: ...
...
class NodeInfo(_message.Message):
    ...
    def __init__(
        self,
        node: _Optional[_Union[LightningNode, _Mapping]] = ...,
        num_channels: _Optional[int] = ...,
        total_capacity: _Optional[int] = ...,
        channels: _Optional[_Iterable[_Union[ChannelEdge, _Mapping]]] = ...,
    ) -> None: ...
...
class LightningNode(_message.Message):
    ...
    def __init__(
        ...
        pub_key: _Optional[str] = ...,
        alias: _Optional[str] = ...,
        addresses: _Optional[_Iterable[_Union[NodeAddress, _Mapping]]] = ...,
        color: _Optional[str] = ...,
        features: _Optional[_Mapping[int, Feature]] = ...,
        custom_records: _Optional[_Mapping[int, bytes]] = ...,
    ) -> None: ...
...
class NodeAddress(_message.Message):
    ...
    addr: str
    def __init__(
        self, network: _Optional[str] = ..., addr: _Optional[str] = ...
    ) -> None: ...
...
class RoutingPolicy(_message.Message):
    ...
    def __init__(
        self,
        time_lock_delta: _Optional[int] = ...,
        min_htlc: _Optional[int] = ...,
        fee_base_msat: _Optional[int] = ...,
        fee_rate_milli_msat: _Optional[int] = ...,
        disabled: bool = ...,
        max_htlc_msat: _Optional[int] = ...,
        last_update: _Optional[int] = ...,
        custom_records: _Optional[_Mapping[int, bytes]] = ...,
        inbound_fee_base_msat: _Optional[int] = ...,
        inbound_fee_rate_milli_msat: _Optional[int] = ...,
    ) -> None: ...
...
class ChannelEdge(_message.Message):
    ...
    def __init__(
        ...
        chan_point: _Optional[str] = ...,
        last_update: _Optional[int] = ...,
        node1_pub: _Optional[str] = ...,
        node2_pub: _Optional[str] = ...,
        capacity: _Optional[int] = ...,
        node1_policy: _Optional[_Union[RoutingPolicy, _Mapping]] = ...,
        node2_policy: _Optional[_Union[RoutingPolicy, _Mapping]] = ...,
        custom_records: _Optional[_Mapping[int, bytes]] = ...,
    ) -> None: ...

class ChannelGraphRequest(_message.Message):
    __slots__ = ("include_unannounced",)
    INCLUDE_UNANNOUNCED_FIELD_NUMBER: _ClassVar[int]
    include_unannounced: bool
    def __init__(self, include_unannounced: bool = ...) -> None: ...
...
class ChannelGraph(_message.Message):
    ...
    def __init__(
        self,
        nodes: _Optional[_Iterable[_Union[LightningNode, _Mapping]]] = ...,
        edges: _Optional[_Iterable[_Union[ChannelEdge, _Mapping]]] = ...,
    ) -> None: ...
...
class NodeMetricsRequest(_message.Message):
    ...
    def __init__(
        self, types: _Optional[_Iterable[_Union[NodeMetricType, str]]] = ...
    ) -> None: ...
...
class FloatMetric(_message.Message):
    ...
    def __init__(
        self, value: _Optional[float] = ..., normalized_value: _Optional[float] = ...
    ) -> None: ...

class ChanInfoRequest(_message.Message):
    __slots__ = ("chan_id", "chan_point")
    CHAN_ID_FIELD_NUMBER: _ClassVar[int]
    CHAN_POINT_FIELD_NUMBER: _ClassVar[int]
    chan_id: int
    chan_point: str
    def __init__(
        self, chan_id: _Optional[int] = ..., chan_point: _Optional[str] = ...
    ) -> None: ...
...
class NetworkInfo(_message.Message):
    ...
    def __init__(
        self,
        graph_diameter: _Optional[int] = ...,
        avg_out_degree: _Optional[float] = ...,
        max_out_degree: _Optional[int] = ...,
        num_nodes: _Optional[int] = ...,
        num_channels: _Optional[int] = ...,
        total_network_capacity: _Optional[int] = ...,
        avg_channel_size: _Optional[float] = ...,
        min_channel_size: _Optional[int] = ...,
        max_channel_size: _Optional[int] = ...,
        median_channel_size_sat: _Optional[int] = ...,
        num_zombie_chans: _Optional[int] = ...,
    ) -> None: ...
...
class GraphTopologyUpdate(_message.Message):
    ...
    def __init__(
        self,
        node_updates: _Optional[_Iterable[_Union[NodeUpdate, _Mapping]]] = ...,
        channel_updates: _Optional[
            _Iterable[_Union[ChannelEdgeUpdate, _Mapping]]
        ] = ...,
        closed_chans: _Optional[_Iterable[_Union[ClosedChannelUpdate, _Mapping]]] = ...,
    ) -> None: ...
...
class NodeUpdate(_message.Message):
    ...
    def __init__(
        ...
        identity_key: _Optional[str] = ...,
        global_features: _Optional[bytes] = ...,
        alias: _Optional[str] = ...,
        color: _Optional[str] = ...,
        node_addresses: _Optional[_Iterable[_Union[NodeAddress, _Mapping]]] = ...,
        features: _Optional[_Mapping[int, Feature]] = ...,
    ) -> None: ...
...
class ChannelEdgeUpdate(_message.Message):
    ...
    def __init__(
        ...
        chan_point: _Optional[_Union[ChannelPoint, _Mapping]] = ...,
        capacity: _Optional[int] = ...,
        routing_policy: _Optional[_Union[RoutingPolicy, _Mapping]] = ...,
        advertising_node: _Optional[str] = ...,
        connecting_node: _Optional[str] = ...,
    ) -> None: ...
...
class HopHint(_message.Message):
    ...
    def __init__(
        ...
        chan_id: _Optional[int] = ...,
        fee_base_msat: _Optional[int] = ...,
        fee_proportional_millionths: _Optional[int] = ...,
...
class RouteHint(_message.Message):
    ...
    def __init__(
        self, hop_hints: _Optional[_Iterable[_Union[HopHint, _Mapping]]] = ...
    ) -> None: ...
...
class BlindedPaymentPath(_message.Message):
    ...
    def __init__(
        self,
        blinded_path: _Optional[_Union[BlindedPath, _Mapping]] = ...,
        base_fee_msat: _Optional[int] = ...,
        proportional_fee_rate: _Optional[int] = ...,
        total_cltv_delta: _Optional[int] = ...,
        htlc_min_msat: _Optional[int] = ...,
        htlc_max_msat: _Optional[int] = ...,
        features: _Optional[_Iterable[_Union[FeatureBit, str]]] = ...,
    ) -> None: ...
...
class BlindedPath(_message.Message):
    ...
    def __init__(
        self,
        introduction_node: _Optional[bytes] = ...,
        blinding_point: _Optional[bytes] = ...,
        blinded_hops: _Optional[_Iterable[_Union[BlindedHop, _Mapping]]] = ...,
    ) -> None: ...
...
class AMPInvoiceState(_message.Message):
    ...
    def __init__(
        self,
        state: _Optional[_Union[InvoiceHTLCState, str]] = ...,
        settle_index: _Optional[int] = ...,
        settle_time: _Optional[int] = ...,
        amt_paid_msat: _Optional[int] = ...,
    ) -> None: ...
...
class Invoice(_message.Message):
    ...
    class AmpInvoiceStateEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[AMPInvoiceState, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        memo: _Optional[str] = ...,
        r_preimage: _Optional[bytes] = ...,
        r_hash: _Optional[bytes] = ...,
        value: _Optional[int] = ...,
        value_msat: _Optional[int] = ...,
        settled: bool = ...,
        creation_date: _Optional[int] = ...,
        settle_date: _Optional[int] = ...,
        payment_request: _Optional[str] = ...,
        description_hash: _Optional[bytes] = ...,
        expiry: _Optional[int] = ...,
        fallback_addr: _Optional[str] = ...,
        cltv_expiry: _Optional[int] = ...,
        route_hints: _Optional[_Iterable[_Union[RouteHint, _Mapping]]] = ...,
        private: bool = ...,
        add_index: _Optional[int] = ...,
        settle_index: _Optional[int] = ...,
        amt_paid: _Optional[int] = ...,
        amt_paid_sat: _Optional[int] = ...,
        amt_paid_msat: _Optional[int] = ...,
        state: _Optional[_Union[Invoice.InvoiceState, str]] = ...,
        htlcs: _Optional[_Iterable[_Union[InvoiceHTLC, _Mapping]]] = ...,
        features: _Optional[_Mapping[int, Feature]] = ...,
        is_keysend: bool = ...,
        payment_addr: _Optional[bytes] = ...,
        is_amp: bool = ...,
        amp_invoice_state: _Optional[_Mapping[str, AMPInvoiceState]] = ...,
        is_blinded: bool = ...,
        blinded_path_config: _Optional[_Union[BlindedPathConfig, _Mapping]] = ...,
    ) -> None: ...

class BlindedPathConfig(_message.Message):
    __slots__ = ("min_num_real_hops", "num_hops", "max_num_paths", "node_omission_list")
    ...
    def __init__(
        self,
        min_num_real_hops: _Optional[int] = ...,
        num_hops: _Optional[int] = ...,
        max_num_paths: _Optional[int] = ...,
        node_omission_list: _Optional[_Iterable[bytes]] = ...,
    ) -> None: ...
...
class InvoiceHTLC(_message.Message):
    ...
    def __init__(
        ...
        htlc_index: _Optional[int] = ...,
        amt_msat: _Optional[int] = ...,
        accept_height: _Optional[int] = ...,
        accept_time: _Optional[int] = ...,
        resolve_time: _Optional[int] = ...,
        expiry_height: _Optional[int] = ...,
        state: _Optional[_Union[InvoiceHTLCState, str]] = ...,
        custom_records: _Optional[_Mapping[int, bytes]] = ...,
        mpp_total_amt_msat: _Optional[int] = ...,
        amp: _Optional[_Union[AMP, _Mapping]] = ...,
    ) -> None: ...
...
class PaymentHash(_message.Message):
    ...
    r_hash: bytes
    def __init__(
        self, r_hash_str: _Optional[str] = ..., r_hash: _Optional[bytes] = ...
    ) -> None: ...
...
class ListInvoiceRequest(_message.Message):
    ...
    def __init__(
        self,
        pending_only: bool = ...,
        index_offset: _Optional[int] = ...,
        num_max_invoices: _Optional[int] = ...,
        reversed: bool = ...,
        creation_date_start: _Optional[int] = ...,
        creation_date_end: _Optional[int] = ...,
    ) -> None: ...
...
class ListInvoiceResponse(_message.Message):
    ...
    def __init__(
        ...
        last_index_offset: _Optional[int] = ...,
        first_index_offset: _Optional[int] = ...,
    ) -> None: ...
...
class InvoiceSubscription(_message.Message):
    ...
    settle_index: int
    def __init__(
        self, add_index: _Optional[int] = ..., settle_index: _Optional[int] = ...
    ) -> None: ...
...
class Payment(_message.Message):
    ...
    def __init__(
        ...
        value_sat: _Optional[int] = ...,
        value_msat: _Optional[int] = ...,
        payment_request: _Optional[str] = ...,
        status: _Optional[_Union[Payment.PaymentStatus, str]] = ...,
        fee_sat: _Optional[int] = ...,
        fee_msat: _Optional[int] = ...,
        creation_time_ns: _Optional[int] = ...,
        htlcs: _Optional[_Iterable[_Union[HTLCAttempt, _Mapping]]] = ...,
        payment_index: _Optional[int] = ...,
        failure_reason: _Optional[_Union[PaymentFailureReason, str]] = ...,
    ) -> None: ...
...
class HTLCAttempt(_message.Message):
    ...
    def __init__(
        ...
        status: _Optional[_Union[HTLCAttempt.HTLCStatus, str]] = ...,
        route: _Optional[_Union[Route, _Mapping]] = ...,
        attempt_time_ns: _Optional[int] = ...,
        resolve_time_ns: _Optional[int] = ...,
        failure: _Optional[_Union[Failure, _Mapping]] = ...,
        preimage: _Optional[bytes] = ...,
    ) -> None: ...
...
class ListPaymentsResponse(_message.Message):
    ...
    def __init__(
        self,
        payments: _Optional[_Iterable[_Union[Payment, _Mapping]]] = ...,
        first_index_offset: _Optional[int] = ...,
        last_index_offset: _Optional[int] = ...,
        total_num_payments: _Optional[int] = ...,
    ) -> None: ...
...
class DeletePaymentRequest(_message.Message):
    ...
    def __init__(
        self, payment_hash: _Optional[bytes] = ..., failed_htlcs_only: bool = ...
    ) -> None: ...
...
class PayReq(_message.Message):
    ...
    def __init__(
        ...
        payment_hash: _Optional[str] = ...,
        num_satoshis: _Optional[int] = ...,
        timestamp: _Optional[int] = ...,
        expiry: _Optional[int] = ...,
        description: _Optional[str] = ...,
        description_hash: _Optional[str] = ...,
        fallback_addr: _Optional[str] = ...,
        cltv_expiry: _Optional[int] = ...,
        route_hints: _Optional[_Iterable[_Union[RouteHint, _Mapping]]] = ...,
        payment_addr: _Optional[bytes] = ...,
        num_msat: _Optional[int] = ...,
        features: _Optional[_Mapping[int, Feature]] = ...,
        blinded_paths: _Optional[_Iterable[_Union[BlindedPaymentPath, _Mapping]]] = ...,
    ) -> None: ...
...
class Feature(_message.Message):
    ...
    is_known: bool
    def __init__(
        self, name: _Optional[str] = ..., is_required: bool = ..., is_known: bool = ...
    ) -> None: ...
...
class ChannelFeeReport(_message.Message):
    ...
    def __init__(
        ...
        channel_point: _Optional[str] = ...,
        base_fee_msat: _Optional[int] = ...,
        fee_per_mil: _Optional[int] = ...,
        fee_rate: _Optional[float] = ...,
        inbound_base_fee_msat: _Optional[int] = ...,
        inbound_fee_per_mil: _Optional[int] = ...,
    ) -> None: ...
...
class FeeReportResponse(_message.Message):
    ...
    def __init__(
        self,
        channel_fees: _Optional[_Iterable[_Union[ChannelFeeReport, _Mapping]]] = ...,
        day_fee_sum: _Optional[int] = ...,
        week_fee_sum: _Optional[int] = ...,
        month_fee_sum: _Optional[int] = ...,
    ) -> None: ...
...
class InboundFee(_message.Message):
    ...
    fee_rate_ppm: int
    def __init__(
        self, base_fee_msat: _Optional[int] = ..., fee_rate_ppm: _Optional[int] = ...
    ) -> None: ...
...
class PolicyUpdateRequest(_message.Message):
    ...
    def __init__(
        ...
        base_fee_msat: _Optional[int] = ...,
        fee_rate: _Optional[float] = ...,
        fee_rate_ppm: _Optional[int] = ...,
        time_lock_delta: _Optional[int] = ...,
        max_htlc_msat: _Optional[int] = ...,
        min_htlc_msat: _Optional[int] = ...,
        min_htlc_msat_specified: bool = ...,
        inbound_fee: _Optional[_Union[InboundFee, _Mapping]] = ...,
        **kwargs
    ) -> None: ...
...
class FailedUpdate(_message.Message):
    ...
    def __init__(
        self,
        outpoint: _Optional[_Union[OutPoint, _Mapping]] = ...,
        reason: _Optional[_Union[UpdateFailure, str]] = ...,
        update_error: _Optional[str] = ...,
    ) -> None: ...
...
class PolicyUpdateResponse(_message.Message):
    ...
    def __init__(
        self, failed_updates: _Optional[_Iterable[_Union[FailedUpdate, _Mapping]]] = ...
    ) -> None: ...
...
class ForwardingEvent(_message.Message):
    ...
    def __init__(
        self,
        timestamp: _Optional[int] = ...,
        chan_id_in: _Optional[int] = ...,
        chan_id_out: _Optional[int] = ...,
        amt_in: _Optional[int] = ...,
        amt_out: _Optional[int] = ...,
        fee: _Optional[int] = ...,
        fee_msat: _Optional[int] = ...,
        amt_in_msat: _Optional[int] = ...,
        amt_out_msat: _Optional[int] = ...,
        timestamp_ns: _Optional[int] = ...,
        peer_alias_in: _Optional[str] = ...,
        peer_alias_out: _Optional[str] = ...,
    ) -> None: ...
...
class ForwardingHistoryResponse(_message.Message):
    ...
    def __init__(
        self,
        forwarding_events: _Optional[
            _Iterable[_Union[ForwardingEvent, _Mapping]]
        ] = ...,
        last_offset_index: _Optional[int] = ...,
    ) -> None: ...
...
class ExportChannelBackupRequest(_message.Message):
    ...
    chan_point: ChannelPoint
    def __init__(
        self, chan_point: _Optional[_Union[ChannelPoint, _Mapping]] = ...
    ) -> None: ...
...
class MultiChanBackup(_message.Message):
    ...
    def __init__(
        self,
        chan_points: _Optional[_Iterable[_Union[ChannelPoint, _Mapping]]] = ...,
        multi_chan_backup: _Optional[bytes] = ...,
    ) -> None: ...
...
class ChanBackupSnapshot(_message.Message):
    ...
    def __init__(
        self,
        single_chan_backups: _Optional[_Union[ChannelBackups, _Mapping]] = ...,
        multi_chan_backup: _Optional[_Union[MultiChanBackup, _Mapping]] = ...,
    ) -> None: ...
...
class ChannelBackups(_message.Message):
    ...
    def __init__(
        self, chan_backups: _Optional[_Iterable[_Union[ChannelBackup, _Mapping]]] = ...
    ) -> None: ...
...
class RestoreChanBackupRequest(_message.Message):
    ...
    def __init__(
        self,
        chan_backups: _Optional[_Union[ChannelBackups, _Mapping]] = ...,
        multi_chan_backup: _Optional[bytes] = ...,
    ) -> None: ...
...
class MacaroonPermission(_message.Message):
    ...
    action: str
    def __init__(
        self, entity: _Optional[str] = ..., action: _Optional[str] = ...
    ) -> None: ...
...
class BakeMacaroonRequest(_message.Message):
    ...
    def __init__(
        self,
        permissions: _Optional[_Iterable[_Union[MacaroonPermission, _Mapping]]] = ...,
        root_key_id: _Optional[int] = ...,
        allow_external_permissions: bool = ...,
    ) -> None: ...
...
class ListPermissionsResponse(_message.Message):
    ...
    class MethodPermissionsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[MacaroonPermissionList, _Mapping]] = ...,
        ) -> None: ...

    METHOD_PERMISSIONS_FIELD_NUMBER: _ClassVar[int]
    method_permissions: _containers.MessageMap[str, MacaroonPermissionList]
    def __init__(
        self, method_permissions: _Optional[_Mapping[str, MacaroonPermissionList]] = ...
    ) -> None: ...
...
class Failure(_message.Message):
    ...
    def __init__(
        self,
        code: _Optional[_Union[Failure.FailureCode, str]] = ...,
        channel_update: _Optional[_Union[ChannelUpdate, _Mapping]] = ...,
        htlc_msat: _Optional[int] = ...,
        onion_sha_256: _Optional[bytes] = ...,
        cltv_expiry: _Optional[int] = ...,
        flags: _Optional[int] = ...,
        failure_source_index: _Optional[int] = ...,
...
class ChannelUpdate(_message.Message):
    ...
    def __init__(
        ...
        chan_id: _Optional[int] = ...,
        timestamp: _Optional[int] = ...,
        message_flags: _Optional[int] = ...,
        channel_flags: _Optional[int] = ...,
        time_lock_delta: _Optional[int] = ...,
        htlc_minimum_msat: _Optional[int] = ...,
        base_fee: _Optional[int] = ...,
        fee_rate: _Optional[int] = ...,
        htlc_maximum_msat: _Optional[int] = ...,
        extra_opaque_data: _Optional[bytes] = ...,
    ) -> None: ...
...
class MacaroonId(_message.Message):
    ...
    def __init__(
        ...
        storageId: _Optional[bytes] = ...,
        ops: _Optional[_Iterable[_Union[Op, _Mapping]]] = ...,
    ) -> None: ...
...
class Op(_message.Message):
    ...
    def __init__(
        self, entity: _Optional[str] = ..., actions: _Optional[_Iterable[str]] = ...
    ) -> None: ...

class CheckMacPermRequest(_message.Message):
    __slots__ = ("macaroon", "permissions", "fullMethod")
    MACAROON_FIELD_NUMBER: _ClassVar[int]
    PERMISSIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        self,
        macaroon: _Optional[bytes] = ...,
        permissions: _Optional[_Iterable[_Union[MacaroonPermission, _Mapping]]] = ...,
        fullMethod: _Optional[str] = ...,
    ) -> None: ...
...
class RPCMiddlewareRequest(_message.Message):
    ...
    def __init__(
        ...
        raw_macaroon: _Optional[bytes] = ...,
        custom_caveat_condition: _Optional[str] = ...,
        stream_auth: _Optional[_Union[StreamAuth, _Mapping]] = ...,
        request: _Optional[_Union[RPCMessage, _Mapping]] = ...,
        response: _Optional[_Union[RPCMessage, _Mapping]] = ...,
        reg_complete: bool = ...,
        msg_id: _Optional[int] = ...,
    ) -> None: ...
...
class RPCMessage(_message.Message):
    ...
    def __init__(
        self,
        method_full_uri: _Optional[str] = ...,
        stream_rpc: bool = ...,
        type_name: _Optional[str] = ...,
        serialized: _Optional[bytes] = ...,
        is_error: bool = ...,
    ) -> None: ...
...
class RPCMiddlewareResponse(_message.Message):
    ...
    def __init__(
        self,
        ref_msg_id: _Optional[int] = ...,
        register: _Optional[_Union[MiddlewareRegistration, _Mapping]] = ...,
        feedback: _Optional[_Union[InterceptFeedback, _Mapping]] = ...,
    ) -> None: ...
...
class MiddlewareRegistration(_message.Message):
    ...
    def __init__(
        self,
        middleware_name: _Optional[str] = ...,
        custom_macaroon_caveat_name: _Optional[str] = ...,
        read_only_mode: bool = ...,
    ) -> None: ...
...
class InterceptFeedback(_message.Message):
    ...
    def __init__(
        ...
        error: _Optional[str] = ...,
        replace_response: bool = ...,
        replacement_serialized: _Optional[bytes] = ...,
    ) -> None: ...
